...
current_version=$(grep -o "__version__ = version = '[0-9.]*'" src/infrash_embedded/_version.py | grep -o "[0-9.]*")
...
cat > src/infrash_embedded/_version.py << EOF
...
setup(
    ...
    author="infrash_embedded Team",
    author_email="info@infrash_embedded.com",
    url="https://github.com/infrash_embedded/python",
...
echo ""
git add src/infrash_embedded/_version.py setup.py "$changelog_file" increment_init.py increment_setup.py
...
rm -rf build/ dist/ src/infrash_embedded.egg-info/
